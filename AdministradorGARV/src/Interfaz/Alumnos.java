...
public class Alumnos extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "DNI", "Nombre", "Apellidos", "Curso", "Empresa"
            }
        ));
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        if (pos == -1) {
            ...
            String alumno = t.getValueAt(pos, 0).toString();
            ModificarAlumno me = new ModificarAlumno(parent, true, alumno);
            me.setVisible(true);
            rellenarTabla();
        }
    ...
    private void rellenarTabla() {
        try {
            ...
            List<Alumno> alumnos = cs.cargarAlumnos();
            DefaultTableModel t = (DefaultTableModel) jTable1.getModel();
            t.setRowCount(0);
            for (int i = 0; i < alumnos.size(); i++) {
                Alumno a = alumnos.get(i);
                Object[] elementos = {a.getId(), a.getDni(), a.getNombre(), a.getApellidos(), a.getCurso(), a.getEmpresa().getNombre()};
                t.addRow(elementos);
            }
